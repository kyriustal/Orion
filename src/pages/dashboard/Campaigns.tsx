...
export default function Campaigns() {
  ...
  const [campaigns, setCampaigns] = useState([
    { id: 1, name: "Promoção Black Friday", template: "oferta_01", status: "SCHEDULED", date: "24/11/2024 08:00", progress: 0 },
    { id: 2, name: "Aviso de Manutenção", template: "aviso_geral", status: "SENDING", date: "Hoje 14:00", progress: 45 },
    { id: 3, name: "Boas Vindas Novos Leads", template: "boas_vindas", status: "COMPLETED", date: "Ontem", progress: 100 },
  ]);
